...
<p>Gracz kontroluje łódź w ściśle określonny sposób. Jednostka może poruszać się po planszy wściśle określony sposób tj. jedynie po linii prostej i o określoną ilość pól (w zależności od kierunku)</p>
<p>
